...
class ContratopersonalController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Contratopersonal');
	 ...
	 * @return Contratopersonal the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Contratopersonal::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Contratopersonal $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='contratopersonal-form')
		{
